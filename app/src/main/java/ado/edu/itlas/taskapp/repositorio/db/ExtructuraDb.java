...
public class ExtructuraDb {
    ...
    public  static final String TABLA_USUARIO="CREATE TABLE usuarios(id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, nombre TEXT, email TEXT, contraceña TEXT, tipoUsuario TEXT)";
}
