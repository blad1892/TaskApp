...
public class ExtructuraDb {
    ...
    public static final String TABLA_TAREAS = "CREATE TABLE tareas(id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, nombre TEXT, descripcion TEXT, fecha DATE,"
            + " fechaTerminado DATE, estado TEXT NOT NULL DEFAULT 'PENDIENTE', categoria TEXT, usuarioCreador TEXT, usuarioAsignado TEXT)";
    public static final String TABLA_USUARIO="CREATE TABLE usuarios(id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, nombre TEXT, email TEXT, contracena TEXT, tipoUsuario TEXT)";
}
